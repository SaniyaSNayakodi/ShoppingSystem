...
<div class="topnav sticky">
	...
	%>
	<center>
		<h2>Online shopping(YourCart))</h2>
	</center>
	<a href="addNewProduct.jsp">Add New Product <i
		...
		class='fas fa-comment-alt'></i></a> <a href="ordersReceived.jsp">Orders
		Received <i class="fas fa-archive"></i>
	</a> <a href="cancelOrders.jsp">Cancel Orders <i
		class='fas fa-window-close'></i></a> <a href="deliveredOrders.jsp">Delivered
